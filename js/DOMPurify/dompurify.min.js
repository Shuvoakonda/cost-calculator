/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */ ! function (e, t) {
    ...
    return function t() {
                ...
                if (!Ae[n] || _e[n]) {
                    ...
                    if (je && !We[n]) {
                        var o = ne(e) || e.parentNode,
                            a = te(e) || e.childNodes;
                        if (a && o)
                            for (var i = a.length - 1; i >= 0; --i) o.insertBefore(Q(a[i], !0), ee(e))
                    }
                    return pt(e), !0
                }
                ...
                if (i) {
                    ...
                    for (a = i.length; a--;) {
                        var c = t = i[a],
                            u = c.name,
                            s = c.namespaceURI;
                        if (n = "value" === u ? t.value : x(t.value), o = he(u), l.attrName = o, l.attrValue = n, l.keepAttr = !0, l.forceKeepAttr = void 0, vt("uponSanitizeAttribute", e, l), n = l.attrValue, !l.forceKeepAttr && (dt(u, e), l.keepAttr))
                            if (k(/\/>/i, n)) dt(u, e);
                            else {
        ...
        return r.sanitize = function (t, o) {
            ...
            } else if (t instanceof u) 1 === (c = (i = ht("\x3c!----\x3e")).ownerDocument.importNode(t, !0)).nodeType && "BODY" === c.nodeName || "HTML" === c.nodeName ? i = c : i.appendChild(c);
            else {
